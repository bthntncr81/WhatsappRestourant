...
const ICONS: Record<string, string> = {
  ...
  package:
    '<path d="M16.5 9.4 7.55 4.24"/><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><path d="M3.29 7 12 12l8.71-5"/><path d="M12 22V12"/>',
  utensils:
  ...
  'bell-off':
    '<path d="M8.7 3A6 6 0 0 1 18 8c0 2.1.3 3.8.9 5.1"/><path d="M3.14 3.14 21 21"/><path d="M10.3 21a1.94 1.94 0 0 0 3.4 0"/><path d="M17 17H3s3-2 3-9a4.67 4.67 0 0 1 .3-1.7"/>',
  'party-popper':
...
export class IconComponent {
  ...
  get svg(): SafeHtml {
    ...
    const raw = `<svg xmlns="http://www.w3.org/2000/svg" width="${this.size}" height="${this.size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${this.strokeWidth}" stroke-linecap="round" stroke-linejoin="round">${inner}</svg>`;
